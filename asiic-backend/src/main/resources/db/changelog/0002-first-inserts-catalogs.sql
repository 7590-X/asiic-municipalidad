INSERT INTO as_tablas (ta_id, ta_nombre) cast (
VALUES
    (1, 'as_cat_estado_civil'),
    (2, 'as_cat_condicion_vecino');


INSERT INTO as_catalogos (ca_tabla, ca_id, ca_valor) VALUES
    (1, 1, 'Soltero(a)'), (1, 2, 'Casado(a)'), (1,3, 'Divorciado(a)'), (1, 4, 'Viudo(a)'),
    (2, 1, 'Propietario'), (2, 2, 'Inquilino'), (2, 3, 'Usufructuario');



INSERT INTO as_locaciones (lo_pais, lo_depto, lo_muni, lo_comuna, lo_nacionalidad, lo_zipcode, lo_fec_registro, lo_descripcion) VALUES
    (1, 0, 0, 0, 'Guatemalteco', null, current_timestamp, 'Guatemala'),
